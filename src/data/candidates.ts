...
export const candidates: Candidate[] = [
  ...
  },
  {
    ...
    tr2: {
      ...
      duration: "58 Minutes",
      focusAreas: [
        "DSA: Basic (arrays, logic, debugging) - Very basic, practical only",
        "HTML & CSS: Theory + small practical",
        "Frontend (JS + React): Strong focus (theory + coding)",
        "Backend (Node/Express): Theory + scenario based",
        "Database: Theory + schema design",
        "Deployment / DevOps: Practical understanding",
        "CS Fundamentals: Light (networking, OOPS)",
      ],
      questions: [
  ...
  },
  {
    ...
    tr2: {
      ...
      duration: "1 Hour",
      focusAreas: [
        "DSA: Basic (arrays, logic, edge cases, time/space complexity)",
        "HTML & CSS: Strong theory + practical (semantic HTML, box model, flexbox, grid, media queries)",
        "Frontend (JavaScript + React): Strong focus (core JS concepts, problem solving, React internals, hooks)",
        "Backend (Node / Express): Theory + scenario based (middleware, async handling, API design, resilience)",
        "Database: Theory + schema design (MongoDB indexing, data modeling, performance)",
        "CS Fundamentals: Light (networking basics, system reliability concepts)",
      ],
      questions: [
  ...
  },
  {
    ...
    tr2: {
      ...
      duration: "1 Hour",
      focusAreas: [
        "DSA: Basic (arrays, prefix sum logic, edge cases, time and space complexity)",
        "HTML & CSS: Theory focused (semantic HTML, responsiveness, component-based UI)",
        "Frontend (JavaScript + React): Strong focus (state management, performance optimization, API integration, React hooks, React Query)",
        "Backend (Node / Express): Theory + real-world scenarios (middleware, payment flows, API integration, error handling)",
        "Database: Theory + schema design (MongoDB modeling, relationships, scalability considerations)",
        "CS Fundamentals: Light (OOPS basics, memory concepts, abstraction vs interface, basic AI awareness)",
      ],
      questions: [
  ...
  },
  {
    ...
    tr2: {
      ...
      focusAreas: [
        "DSA: Basic to moderate (arrays, prefix/suffix logic, edge cases, time/space complexity)",
        "HTML & CSS: Strong theory focus (semantic HTML, flexbox vs grid, media queries, accessibility, SEO)",
        "Frontend (JavaScript + React): Strong focus (closures, this keyword, controlled vs uncontrolled components, reconciliation, performance)",
        "Backend (Node / Express): Strong focus (middleware, async handling, pagination, API design, resilience)",
        "Database: Theory + practical usage (MongoDB indexing, schema thinking, pagination queries)",
        "CS Fundamentals: Light to moderate (OS basics, memory concepts, abstraction, interface)",
      ],
      questions: [
